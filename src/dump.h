...
void write_mpiio_dump(VD &headerDbls , VI &headerInts , mpiInfo &myMPI)
{
  ...
  if ( myPE == 0 ) 
    {
      for ( int i = 0 ; i < headerDbls.size() ; ++i ) write_mpiio_double( fh , /* TO-DO */ , offset);
      for ( int i = 0 ; i < headerInts.size() ; ++i ) write_mpiio_int   ( fh , /* TO-DO */ , offset);
    }
...
void read_mpiio_dump(VD &headerDbls , VI &headerInts , mpiInfo &myMPI)
{
  ...
  // -
    ...
    for ( int i = 0 ; i < headerDbls.size() ; ++i ) read_mpiio_double( fh , /* TO-DO */ , offset);
    for ( int i = 0 ; i < headerInts.size() ; ++i ) read_mpiio_int   ( fh , /* TO-DO */ , offset);
